"""inclusao de campo meta na class KRGeradoChatAprovacao

Revision ID: 5b6b2bfa1ba1
Revises: cef45ef8be2a
Create Date: 2023-08-02 15:21:05.813876
...
revision = '5b6b2bfa1ba1'
down_revision = 'cef45ef8be2a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('kr_gerado_chat_aprovacao', schema=None) as batch_op:
