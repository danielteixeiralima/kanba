"""mudança class TarefaMetasSemanais campo squad 3

Revision ID: 61f57761dabd
Revises: fd744b6e83f5
Create Date: 2023-08-07 20:17:24.151318
...
revision = '61f57761dabd'
down_revision = 'fd744b6e83f5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('tarefas_metas_semanais', schema=None) as batch_op:
        batch_op.add_column(sa.Column('squad_name', sa.String(length=255), nullable=False))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('tarefas_metas_semanais', schema=None) as batch_op:
        batch_op.drop_column('squad_name')
