"""mudança class MacroAcao

Revision ID: 307a020a954a
Revises: 91cdb90e5920
Create Date: 2023-08-07 14:47:42.440844
...
revision = '307a020a954a'
down_revision = '91cdb90e5920'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('macro_acao', schema=None) as batch_op:
        batch_op.add_column(sa.Column('squad', sa.VARCHAR(length=500), autoincrement=False, nullable=False))
